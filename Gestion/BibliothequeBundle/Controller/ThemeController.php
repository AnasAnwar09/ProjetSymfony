...
use Gestion\BibliothequeBundle\Entity\Theme;
use Gestion\BibliothequeBundle\Form\FormConservateur\ThemeType;
...
class ThemeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GestionBibliothequeBundle:Theme')->findAll();

        return $this->render('GestionBibliothequeBundle:Theme:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('GestionBibliothequeBundle:Theme:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GestionBibliothequeBundle:Theme')->find($id);
        ...
        return $this->render('GestionBibliothequeBundle:Theme:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('GestionBibliothequeBundle:Theme:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        if ($form->isValid()) {
            ...
            $livre = $entity->getLivreTheme();
            $nombreLivre = count($livre);
            if ($nombreLivre == 0){
                $em->remove($entity);
                $em->flush();
                $url = $this->generateUrl('theme');
                return $this->redirect($url);
            }else{
                $request->getSession()->getFlashBag()->add('notice', 'ATTENTION : ce thème est déja attribué à un livre  !!');
                $url = $this->generateUrl('theme');
                return $this->redirect($url);
            }
        }
